...
describe('Mathobject Actions', () => {
    ...
    describe('constantMultiplication', () => {
        const tests: ActionTest[] = [
            ...
            new ActionTest({ mo: new Term('2*E'), finalResult: '2*E' }),
            new ActionTest({ mo: new Term('-PI*2'), finalResult: '-PI*2' }),
    ...
    describe('constantAdditionSubtraction', () => {
        const tests: ActionTest[] = [
            ...
            new ActionTest({ mo: new Term('2.5+3.5'), finalResult: '(6)', beforeHighlights: [['2.5', '3.5']], afterHighlights: [['6']], actions: [ActionTypes.constantAdditionSubtraction] }),
