...
import { Ln } from "src/models/math-object/factor/functions/log-ln/ln.model";
import { Log } from "src/models/math-object/factor/functions/log-ln/log.model";
...
describe('Factory', () => {
    ...
    describe('buildFactor', () => {
        const inputs: { input: string, type: Type<MathObject>}[] = [
            ...
            { input: '.3', type: Double },
            { input: '-1.2', type: Double },
            { input: 'e', type: Variable },
            { input: 'E', type: E },
            { input: 'pi', type: Variable },
            { input: 'PI', type: PI },
